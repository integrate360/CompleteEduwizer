...
import { emptyBlogForm } from "./blogFormUtils";

export default function BlogFormModal({ open, saving, title, value, onChange, onClose, onSave }) {
  const form = value || emptyBlogForm;

  return (
    <Modal open={open} title={title} description="Create or update a blog post." onClose={saving ? undefined : onClose}>
